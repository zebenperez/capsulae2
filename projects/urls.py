...
urlpatterns = [
    ...
    path('projects/financiers/list/', views.financier_list, name='financier-list'),
    ...
    path('projects/financiers/', views.project_financiers, name='project-financiers'),
    path('projects/project-financier-form/', views.project_financier_form, name='project-financier-form'),
    path('projects/project-financier-save/', views.project_financier_save, name='project-financier-save'),
    path('projects/project-financier-remove/', views.project_financier_remove, name='project-financier-remove'),
    ...
    path('projects/budget-lines/', views.project_budget_lines, name='project-budget-lines'),
    path('projects/budget-line-form/', views.project_budget_line_form, name='project-budget-line-form'),
    path('projects/budget-line-remove/', views.project_budget_line_remove, name='project-budget-line-remove'),
    path('projects/sub-budget-line-form/', views.project_sub_budget_line_form, name='project-sub-budget-line-form'),
    path('projects/sub-budget-line-remove/', views.project_sub_budget_line_remove, name='project-sub-budget-line-remove'),
    path('projects/financier-contribution-form/', views.project_financier_contribution_form, name='project-financier-contribution-form'),
    path('projects/financier-contribution-save/', views.project_financier_contribution_save, name='project-financier-contribution-save'),
    path('projects/financier-contribution-remove/', views.project_financier_contribution_remove, name='project-financier-contribution-remove'),
