...
urlpatterns = [
    ...
    path('bibliomecum/title-author-search/', views.title_author_search, name='bibliomecum-title-author-search'),
    path('bibliomecum/atc-search/', views.atc_search, name='bibliomecum-atc-search'),
    path('bibliomecum/atc-patient/', views.atc_patient, name='bibliomecum-atc-patient'),
    path('bibliomecum/ciap-search/', views.ciap_search, name='bibliomecum-ciap-search'),
    path('bibliomecum/ciap-patient/', views.ciap_patient, name='bibliomecum-ciap-patient'),
]
